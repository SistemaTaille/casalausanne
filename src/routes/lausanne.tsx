...
function Index() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      {/* Nav */}
      <header
        className={`fixed top-0 z-50 w-full border-b border-border/60 bg-background transition-all duration-500 md:border-transparent ${
          scrolled ? "py-4 md:bg-background/85 md:backdrop-blur-md md:border-border/60" : "py-4 md:py-8 md:bg-transparent md:backdrop-blur-none"
        }`}
      >
      ...
      <section id="topo" className="relative h-screen min-h-[700px] w-full overflow-hidden bg-foreground">
        ...
        <div className="relative z-10 mx-auto flex h-full max-w-[1600px] flex-col justify-end px-6 pb-16 md:px-12 md:pb-24">
          ...
          <p className="kicker reveal mt-6 text-sm text-background tracking-[0.22em] font-medium" style={{ color: "var(--background)" }}>
